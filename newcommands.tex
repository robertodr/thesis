...
\newcommand{\pcmsolver}{\href{http://pcmsolver.readthedocs.org}{\textsc{PCMSolver}}~}
...
\newcommand*{\scalprod}[2]{(#1, #2)_{\Gamma}} % Scalar product
...
\newcommand*{\commutator}[3][]{\left[ #2, #3 \right]^{#1}} % Commutator
