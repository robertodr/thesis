...
published in the proceedings of the \emph{Producing High
Performance and Sustainable Software for Molecular Simulation} workshop
held at the 2015 Supercomputing Conference.\autocite{%SC15, Trott2016-pf,
DiRemigio2016-es}
...
\begarrowthought{The growing complexity of quantum chemical program
  packages} requires that an
...
\arrowthought{The idea of a \emph{modular programming paradigm} can be traced back to
...
\acp{DVCS},\footnote{\url{https://github.com/} \\
\url{https://gitlab.com/}}
continuous integration,\footnote{\url{https://travis-ci.org/} \\
\url{https://www.appveyor.com/} \\
\url{https://magnum-ci.com}}
code coverage analysis,\footnote{\url{https://coveralls.io/}}
static and dynamic code analyses,\footnote{\url{https://scan.coverity.com/}}
nightly regression testing, public
...
\arrowthought{The \acrshort{PCM} is an ideal candidate} for the creation of a solvation
...
The adoption of git\footnote{\url{https://git-scm.com/}} as \acrshort{DVCS},
CMake\footnote{\url{https://cmake.org/}} for cross-platform builds and
automatic documentation deployment on ReadTheDocs\footnote{\url{https://readthedocs.org/}} simplify
...
Judicious usage of the C++ object-oriented paradigm is the key to this
...
functions.\autocite{library-ronacher}\footnote{\url{https://github.com/bast/context-api-example}}
...
host program, respectively.

\lstinputlisting[language=C,
                 caption={Relevant calls to \pcmsolver in a C host program.
                 Ellipses in the functions' argument list stand for omitted parameters.
                 For the full, functional example visit
                 \url{http://pcmsolver.readthedocs.io/en/v1.1.6/users/C-example.html}},
                 label={lst:C-host}
                ]{snippets/C_host.c}
...
\lstinputlisting[language=Fortran,
                 ...
                 Ellipses in the functions' argument list stand for omitted parameters.
                 For the full, functional example visit
                 \url{http://pcmsolver.readthedocs.io/en/v1.1.6/users/fortran-example.html}},
...
\arrowthought{Programming effort in this dissertation} has not only been directed at the
...
In \paper{I} we presented the first derivation and implementation of the \acrshort{PCM}
...
The main point of \paper{I} was, however, the adoption of a fully modular
programming strategy. We showed that it is entirely possible to adopt the same
\acrshort{PCM} code and implementation \enquote{checkpoints} across altogether different
...
Already~\citeauthor{Weijo2010-hy} had shown that using \gls{PWC} wavelet bases can lead
...
\gls{PWL} wavelet bases are used instead.
...
For \paper{II}, I provided template interface and test sets for the cavity
...
In this work, we analyzed both effects on the water-vapor and oil-water transfer
...
the Coulomb singularity in its final form.\footnote{
Equation (40) for $G_\mathrm{img}(\vect{r}, \vect{r}^\prime)$ in the
final published version of the paper contains a misprint. The
parentheses should not appear.}
...
the measured signal.
Our group has recently developed an open-ended methodology for the computation of
\acrshort{SCF} response functions\autocite{Thorvaldsen2008-sg, Ringholm2014-gx} and
their single residues.\autocite{Friese2015-kb}
