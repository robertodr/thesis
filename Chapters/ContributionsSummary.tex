...
The \acs{API} is implemented in ISO C99 as a \emph{context-aware} set of
...
\lstinputlisting[language=C,
                 ...
                 \url{http://pcmsolver.readthedocs.io/en/latest/users/C-example.html}},
                 label={lst:C-host}
                ]{snippets/C_host.c}
...
\lstinputlisting[language=Fortran,
                 ...
                 Ellipsis in the functions arguments list stand for omitted parameters.
                 For the full, functional example visit
                 \url{http://pcmsolver.readthedocs.io/en/latest/users/fortran-example.html}},
