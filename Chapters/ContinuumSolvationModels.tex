...
polarization of solute and solvent (Section \ref{sec:IEF})
...
%and the most sensitive to changes in the
%system studied and in the level of quantum mechanical description.

\begin{figure}[!h]
  \centering
  \includegraphics[width=.5\textwidth]{IEF.png}
...
The wavelet Galerkin \acrshort{BEM} was also used in this dissertation. This method
...
In this dissertation we advocate a different theoretical approach: the
variational formulation of classical polarizable models.
