...
Also, acronyms should be properly set up and reference to stuff not included in the thesis
(time-dependent) removed.}
...
The growing complexity of quantum chemical program packages requires
