...
\todo[inline]{This expression is consistent with electrostatics and
perturbation theory. Comment how this wouldn't be the case if one uses
the nonlinear Hamiltonian formulation for the quantum/classical coupling.}
...
\todo[inline]{Develop MBPT for the approximate Lagrangians}
...
\todo[inline]{Give the CC2, CC3 and the (T) corrections (symmetric and
