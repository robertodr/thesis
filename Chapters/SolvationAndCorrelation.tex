...
derivations of \acrshort{MBPT} and \acrshort{CC} theory, encompassing previous
...
After introducing the notation, I will derive the form of the \acrshort{CC}
effective Lagrangian and proceed to show how the work of
\citeauthor{Cammi2009-gu} and \citeauthor{Caricato2011-tx} on
\acrshort{PCM}-\acrshort{CC} and \citeauthor{Sneskov} on \acrshort{PE}-\acrshort{CC}
...
operators has been introduced.~\autocite{Crawford2000-ey, Shavitt}
