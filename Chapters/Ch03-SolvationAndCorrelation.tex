...
%************************************************
\chapter{A New Perspective on Electron Correlation and Solvation}\label{ch:solvation-correlation}
...
\end{equation}
so that the governing equations for the \acs{PTES} scheme become:
\begin{subequations}
  \begin{align}
...
The \acs{PTES} approximation can be brought one step further, by
