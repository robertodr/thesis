...
This document makes use of hyperlinks within and without to ease reading
and navigation. A numbered citation style was chosen.
Citations are color-coded in \textcolor{brewerCitation}{green}, appear
(most often) as superscripts and are hyperlinked to the bibliography.
Acronyms are color-coded in \textcolor{brewerGray}{gray} and
hyperlinked to the list of acronyms.
Finally, URLs and placeholders for URLs are color-coded in
\textcolor{brewerURL}{orange}.
They are hyperlinked to the respective online resource.
}
