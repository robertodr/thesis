...
\begin{figure}[tb]
\centering
\scalebox{0.7}{\input{gfx/RQC-axes.tikz}}
...
\todo[inline]{Classification of solute-solvent interactions. The focus
on electrostatics.}
...
To partly alleviate these sources of error, the \acrshort{QM}/\acrshort{MM} and
\acrshort{QM}/Continuum methods can and have been successfully combined to
yield the three-layer \acrshort{QM}/\acrshort{MM}/Continuum method.~\autocite{Curutchet, Steindal Lipparini}
