...
%\usepackage{amssymb}
\usepackage{fontspec}
\setmainfont[Ligatures=TeX, Numbers=OldStyle, Scale=0.9]{TeX Gyre Termes}
\newfontfamily\greekfont[Script=Greek, Scale=0.9]{Linux Libertine O}
\newfontfamily\greekfontsf[Script=Greek, Scale=0.9]{Linux Libertine O}
